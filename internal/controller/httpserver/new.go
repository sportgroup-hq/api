...
type GroupService interface {
	...
	CreateGroup(ctx context.Context, creatorID uuid.UUID, group models.CreateGroupRequest) (*models.Group, error)
...
type EventService interface {
	...
	CreateEventComment(ctx context.Context, userID, groupID, eventID uuid.UUID, ccr *models.CreateCommentRequest) error
	GetEventComments(ctx context.Context, userID, groupID, eventID uuid.UUID) ([]models.EventComment, error)
}
